...
export class ContainsStringOperator implements IStringOperator {
  static errors = {
    ...
    const operatorConditions: IOperatorConditions[] = [
      {
        ...
        assumption: false,
        error: ContainsStringOperator.errors.operatorArgumentsLengthInvalid,
      },
      {
        condition: this.isOperatorSecondArgumentString,
        assumption: false,
        error: ContainsStringOperator.errors.operatorArgumentsTypesError,
      },
    ];

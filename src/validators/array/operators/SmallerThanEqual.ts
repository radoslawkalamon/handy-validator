...
export class SmallerThanEqualArrayOperator implements IArrayOperator {
  static errors = {
    ...
    const operatorConditions: IOperatorConditions[] = [
      {
        ...
        assumption: false,
        error: SmallerThanEqualArrayOperator.errors.operatorArgumentsLengthInvalid,
      },
      {
        condition: this.isOperatorSecondArgumentInteger,
        assumption: false,
        error: SmallerThanEqualArrayOperator.errors.operatorArgumentsTypesError,
      },
    ];

...
export class EqualToArrayOperator implements IArrayOperator {
  static errors = {
    ...
    const operatorConditions: IOperatorConditions[] = [
      {
        ...
        assumption: false,
        error: EqualToArrayOperator.errors.operatorArgumentsLengthInvalid,
      },
      {
        condition: this.isOperatorSecondArgumentInteger,
        assumption: false,
        error: EqualToArrayOperator.errors.operatorArgumentsTypesError,
      },
    ];

...
export class EqualToNumberOperator implements INumberOperator {
  static errors = {
    ...
    const operatorConditions: IOperatorConditions[] = [
      {
        ...
        assumption: false,
        error: EqualToNumberOperator.errors.operatorArgumentsLengthInvalid,
      },
      {
        condition: this.isOperatorSecondArgumentNumber,
        assumption: false,
        error: EqualToNumberOperator.errors.operatorArgumentsTypesError,
      },
    ];

...
export class SmallerThanNumberOperator implements INumberOperator {
  static errors = {
    ...
    const operatorConditions: IOperatorConditions[] = [
      {
        ...
        assumption: false,
        error: SmallerThanNumberOperator.errors.operatorArgumentsLengthInvalid,
      },
      {
        condition: this.isOperatorSecondArgumentNumber,
        assumption: false,
        error: SmallerThanNumberOperator.errors.operatorArgumentsTypesError,
      },
    ];
